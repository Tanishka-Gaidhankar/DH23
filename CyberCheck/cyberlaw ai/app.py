...
def ask_question():
    try:
        ...
        # Convert markdown-styled text into HTML for better reading
        formatted_answer = markdown.markdown(plain_text)

        # Return both plain text and HTML formatted answer
        return jsonify({"answer": plain_text, "formatted_answer": formatted_answer})
